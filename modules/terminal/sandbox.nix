...
in
{
  ...
  config = mkIf (config.keystone.terminal.enable && cfg.enable) (mkMerge [
    ...
    {
      home.packages = [
        pkgs.keystone-terminal.podman-agent
      ];
      ...
      home.sessionVariables = {
        ...
        PODMAN_AGENT_CLAUDE_CODE_PATH = "${pkgs.keystone-terminal.claude-code}";
        PODMAN_AGENT_GEMINI_CLI_PATH = "${pkgs.keystone-terminal.gemini-cli}";
        PODMAN_AGENT_CODEX_PATH = "${pkgs.keystone-terminal.codex}";
        PODMAN_AGENT_OPENCODE_PATH = "${pkgs.keystone-terminal.opencode}";
        ...
        PODMAN_AGENT_CHROME_MCP_PATH = "${pkgs.keystone-terminal.chrome-devtools-mcp}";
      }
